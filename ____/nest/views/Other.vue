<template>
  <DefaultLayout>
    <div class="view">
      <nav class="menu">
        <a class="menu__item" @click="openFeedbackWindow">
          <svg
            width="26"
            height="26"
            viewBox="0 0 16 16"
        ...
        <a class="menu__item" @click="openReleaseNotesWindow">
          <svg
            width="26"
            height="26"
            viewBox="0 0 16 16"
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M1.49915 2H14.4991L14.9991 2.5V12.5L14.4991 13H1.49915L0.999146 12.5V2.5L1.49915 2ZM1.99915 3V12H13.9991V3H1.99915ZM3.99915 5H11.9991V6H3.99915V5ZM9.99915 7H3.99915V8H9.99915V7ZM3.99915 9H7.99915V10H3.99915V9Z"
              fill="currentColor"
            />
          </svg>
  ...
  setup() {
    ...
    function openFeedbackWindow() {
      vscode.postMessage({
        ...
        payload: {
          title: "Feedback",
          url: "https://forms.clickup.com/f/4bj41-2143/P26FKH9YXJAN6H473W",
        },
      });
    }
    function openReleaseNotesWindow() {
      vscode.postMessage({
        ...
        payload: {
          title: "Release Notes",
          url: "https://doc.clickup.com/d/h/4bj41-2157/fb7383b07e9f14e",
        },
      });
    }
    return { openFeedbackWindow, openReleaseNotesWindow };
  },
});
</script>
