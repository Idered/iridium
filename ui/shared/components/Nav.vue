<template>
  <div class="nav">
    <NavLink to="/entities" class="nav__item">Entities</NavLink>
    <NavLink to="/database" class="nav__item">Database</NavLink>

    <!-- <NavLink to="/controllers" class="nav__item">Controllers</NavLink> -->
    <NavLink to="/other" class="nav__item nav__item--other">
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
...
.nav__item:focus {
  border-left-color: var(--vscode-tab-border);
  outline: 0;
}
.nav__item:hover {
